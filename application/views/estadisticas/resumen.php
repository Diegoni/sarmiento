				...
				<div class="col-xs-12 divider text-center">
							<div class="col-xs-12 col-sm-4 emphasis">
                                ...
                                <div class="inner">
                                    <h4>
										<?php 
											if(isset($remito_total))
											{
												echo "$ ".round($remito_total,2);
											}else
											{
												echo "$ ".round(0,2);
											}											
							...
							<div class="col-xs-12 col-sm-4 emphasis">
                                ...
                                <div class="inner">
                                    <h4>
                                       <?php 
											if(isset($devolucion_total))
											{
												echo "$ ".round($devolucion_total,2);
											}else
											{
												echo "$ ".round(0,2);
											}		
							...
							<div class="col-xs-12 col-sm-4 emphasis">
                                ...
                                <div class="inner">
                                    <h4>
										<?php 
											if(isset($devolucion_total) && isset($remito_total))
											{
												echo "$ ".round($remito_total-$devolucion_total,2);
											}else
											{
												echo "$ ".round(0,2);
											}		
